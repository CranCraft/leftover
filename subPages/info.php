					...
					<div class="row">
						<div class="col-md-12">
							<div class="caption">
								...
								<p>auf der <a href="index.php"> startseite</a> werden euch die grundzutaten angezeigt von denen ihr</br>
									noch was im schrank habt. von denen wählt ihr eine aus und werdet dann</br>
									zu den verschiedenen rezepten weitergeleitet.</br>
									diese zeigen euch dann schritt für schritt wie ihr euer geschmackserlebnis zubereitet.   </p>
						</div> 
					</div>
				</div>
				<div id="footer"></div>
